...
- Desktop notifications are delivered through the operating system's local notification system. They contain the significance reason, application name, and country.
